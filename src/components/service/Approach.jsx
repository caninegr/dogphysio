...
const approachContent = [
  ...
  },
  {
    subTitle: "5",
    title: "Συντήρηση",
    descriptions: `Η δουλειά μας δεν τελειώνει στο φυσικοθεραπευτήριο. Αν θέλεις να διαρκέσει το αποτέλεσμα πρέπει να ακολουθήσεις έναν διαφορετικό τρόπο ζωής στο σπίτι.`,
    delayAnimation: "400",
  },
  {
    subTitle: "6",
