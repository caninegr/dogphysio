...
const approachContent = [
  ...
  },
  {
    subTitle: "3",
    title: "Αξιολόγηση",
    descriptions: `Κλείσε ένα ραντεβού αξιολόγησης μαζί μας και έλα να σε καθοδηγήσουμε.`,
    delayAnimation: "200",
  },
  {
    subTitle: "4",
  ...
  },
  {
    subTitle: "5",
    title: "Συντήρηση",
    descriptions: `Η δουλειά μας δεν τελειώνει στο φυσικοθεραπευτήριο. Αν θέλεις να διαρκέσει το αποτέλεσμα πρέπει το να ακολουθήσεις έναν διαφορετικό τρόπο ζωής στο σπίτι.`,
    delayAnimation: "400",
  },
  {
    subTitle: "6",
